...
Tous les rapports terminés sont disponibles dans la variable [!UICONTROL Latest Reports] de la [!UICONTROL Reports] et vous pouvez les afficher au format de tableau dans la fenêtre du navigateur ou les ouvrir ou les télécharger sous forme de fichiers.

## Catégories de rapports disponibles

Les catégories de rapports suivantes sont disponibles dans la variable [!UICONTROL Reports] vue. Vous n’avez peut-être pas accès à tous ces rapports ; les rapports disponibles et les données qu’ils génèrent sont déterminés par votre rôle et la manière dont votre compte client est configuré.
...
| [!UICONTROL Assist Reports] | [Rapports d’assistance](/help/search-social-commerce/reports/management/assist/assist-report-about.md) fournissent des informations sur les chemins de conversion de tous les mots-clés et publicités d’un annonceur. Ils utilisent les données capturées par le biais du service de suivi de conversion d’Adobe Advertising et peuvent uniquement être générées pour les annonceurs disposant du service. |
| [!UICONTROL Specialty Reports] | [Rapports de spécialité](/help/search-social-commerce/reports/management/specialty/specialty-report-about.md) se composent de données collectées par les réseaux publicitaires (plutôt que par le suivi des Adobes Advertising). |
...
La variable [!UICONTROL Reports] vues à [!UICONTROL Search] > [!UICONTROL Insights & Reports] > [!UICONTROL Reports] vous permet de créer et de gérer des rapports, des modèles et des flux de feuille de calcul. La vue comprend deux onglets :

* La variable **[!UICONTROL Latest Reports]** répertorie tous les rapports disponibles qui ont été demandés au cours des sept derniers jours, à l’exception de ceux qui ont été supprimés manuellement. Par défaut, le rapport le plus récent se trouve en haut. Les informations affichées pour chaque rapport incluent le planning selon lequel il sera exécuté (le cas échéant), les dates de début et de fin pour lesquelles des données ont été générées ou le seront, ainsi que l’état du rapport (*[!UICONTROL Finished]*, *[!UICONTROL In Progress]*, ou *[!UICONTROL Error]*).
...
* La variable **[!UICONTROL Templates]** répertorie tous les modèles de rapports de base et avancés enregistrés disponibles, y compris des informations sur les plannings qui leur sont associés. Le modèle le plus récent se trouve en haut par défaut.
...
| Objectif | Rapport |
| ---- | ---- |
| Surveillance des performances | <ul><li>[La variable [!UICONTROL Portfolio Report]](/help/search-social-commerce/reports/management/basic-advanced/portfolio-report.md)</li><li>[La variable [!UICONTROL Search Engine Report]](/help/search-social-commerce/reports/management/basic-advanced/search-engine-report.md)</li><li>[La variable [!UICONTROL Search Engine Account Report]](/help/search-social-commerce/reports/management/basic-advanced/search-engine-account-report.md)</li><li>[La variable [!UICONTROL Campaign Report]](/help/search-social-commerce/reports/management/basic-advanced/campaign-report.md)</li><li>[La variable [!UICONTROL Ad Group Report]](/help/search-social-commerce/reports/management/basic-advanced/ad-group-report.md)</li><li>[La variable [!UICONTROL Forecast Accuracy Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-report.md)</li></ul> |
| Dépannage des performances et analyse des tendances | <ul><li>[La variable [!UICONTROL Keyword Report]](/help/search-social-commerce/reports/management/basic-advanced/keyword-report.md)</li><li>[La variable [!UICONTROL Ad Variation Report]](/help/search-social-commerce/reports/management/basic-advanced/ad-variation-report.md)</li><li>[La variable [!UICONTROL Transaction Report]](/help/search-social-commerce/reports/management/basic-advanced/transaction-report.md)</li><li>[La variable [!UICONTROL RSA Asset Report]](/help/search-social-commerce/reports/management/specialty/rsa-asset-report.md)</li><li>[La variable [!UICONTROL Keyword Daily Impression Share Report]](/help/search-social-commerce/reports/management/specialty/keyword-daily-impression-share-report.md) et [La variable [!UICONTROL Campaign Daily Impression Share Report]](/help/search-social-commerce/reports/management/specialty/campaign-daily-impression-share-report.md)</li><li>Tout rapport de base qui compare deux fenêtres temporelles à l’aide du[!UICONTROL Compare with]fonction &quot;</li></ul> |
| Identifier les opportunités de croissance économique | <ul><li>(Publicitaires avec suivi des conversions par Adobe Advertising uniquement) [La variable [!UICONTROL Geo Distribution Report]](/help/search-social-commerce/reports/management/basic-advanced/geo-distribution-report.md)</li><li>(Publicitaires avec suivi des conversions par Adobe Advertising uniquement) [La variable [!UICONTROL Domain Referral Report]](/help/search-social-commerce/reports/management/basic-advanced/domain-referral-report.md)</li><li>(Publicitaires avec [Adobe [!DNL Analytics for Advertising]](https://experienceleague.adobe.com/docs/advertising/integrations/analytics/overview.html)) Rapports personnalisés dans Adobe Analytics Analysis Workspace</li></ul> |
| Analytics | <ul><li>(Publicitaires avec suivi des conversions par Adobe Advertising uniquement) [La variable [!UICONTROL Channel Assist Report]](/help/search-social-commerce/reports/management/assist/channel-assist-report.md)</li><li>(Publicitaires avec [Adobe [!DNL Analytics for Advertising]](https://experienceleague.adobe.com/docs/advertising/integrations/analytics/overview.html)) Rapports personnalisés dans Adobe Analytics Analysis Workspace</li></ul> |
