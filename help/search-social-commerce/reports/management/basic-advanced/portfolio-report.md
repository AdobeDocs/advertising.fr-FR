...
description: En savoir plus sur le [!UICONTROL Portfolio Report].
...
La [!UICONTROL Portfolio Report] inclut les données de coût, de clic et (éventuellement) de conversion pour un ou plusieurs portefeuilles. Par défaut, les données incluent une ligne pour chaque portfolio applicable pour chaque unité de temps dans la période spécifiée, et les lignes sont dans l’ordre croissant d’abord par portfolio, puis par la date de début pour l’unité de temps.
