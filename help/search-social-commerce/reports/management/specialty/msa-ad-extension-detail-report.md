...
description: En savoir plus sur le [!UICONTROL MSA Ad Extension Detail Report].
...
Ce rapport présente les impressions, les clics, les dépenses et le coût moyen par clic pour les éléments d’extension d’annonce individuels (tels que chaque lien dans une extension de lien de site). Utilisez ce rapport pour évaluer l’efficacité des éléments de votre extension publicitaire.

Lorsque vous exécutez un rapport avec uniquement des colonnes de mesures et sans dimensions, le rapport généré contient deux lignes en double : l’une avec des données agrégées et l’autre avec toutes les mesures.<!-- all metrics? -->
