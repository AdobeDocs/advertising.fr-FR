...
+ (Beta) NOUVELLE INTERFACE UTILISATEUR {#new-ui}
   ...
   + Gérer {#manage}
      ...
      + Campagnes {#campaigns}
         ...
         + [Renommer une campagne](/help/search-social-commerce/new-ui/manage/campaigns/campaign-rename.md)
      + Groupes publicitaires {#ad-groups}
         ...
         + [Modifier le statut d’un groupe publicitaire](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-change-status.md)
         + [Renommer un groupe publicitaire](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-rename.md)
      + Publicités {#ads}
   ...
   + Rapports {#reports}
      + Rapports planifiés {#scheduled}
         + [Rapports](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/report-about){target="_blank"}
         + [Tâches de configuration initiales pour les rapports](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/initial-setup){target="_blank"}
         + [Données utilisées pour les rapports](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/data-used-for-reports){target="_blank"}
         + Gestion des rapports planifiés {#management}
...
Assister les formats de rapport {#assist-report-formats}
   ...
   + Target {#target}
      ...
      + Stages {#placements}
         ...
         + [Gérer les affectations de contraintes pour les emplacements](/help/search-social-commerce/new-ui/target/placements/placement-assignments-manage.md)
   + Configuration {#setup}
      + Comptes {#accounts}
      ...
      + Gestion des données dans les vues [!UICONTROL Campaigns] > [!UICONTROL Campaigns] {#campaigns}
         ...
         + Mots-clés {#keywords}
            ...
            + Paramètres des mots-clés par réseau publicitaire {#keyword-settings-by-network}
               ...
               + [Paramètres des mots-clés [!DNL Yahoo! Japan Ads]](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)
