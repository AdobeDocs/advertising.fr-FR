...
+ Introduction {#intro}
   ...
   + Intégration à Adobe Experience Cloud {#integrations}
      ...
      + [Adobe [!DNL Analytics for Advertising] (lien)](https://experienceleague.adobe.com/docs/advertising/integrations/analytics/overview.html)
      + [Intégration à Adobe Audience Manager (lien)](https://experienceleague.adobe.com/docs/advertising/integrations/audience-manager/overview.html)
   + [Prise en charge de la confidentialité des utilisateurs (lien)](https://experienceleague.adobe.com/docs/advertising/privacy/home.html)
   + [Stratégies et directives (lien)](https://experienceleague.adobe.com/docs/advertising/policies/ad-requirements-policy.html)
...
+ Tâches courantes {#common-tasks}
   ...
   + Personnalisation des vues de données {#data-views}
      ...
      + Paramètres d’affichage ad hoc {#ad-hoc-settings}
         ...
         + [Réorganisation d’une colonne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-sort.md)
...
+ Tracking {#tracking}
   ...
   + Suivi des clics {#click-tracking}
      ...
      + [Cookies Adobe Advertising](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-advertising-cloud.html)
   ...
   + Suivi des conversions {#conversion-tracking}
      ...
      + Conversions suivies par les annonceurs à l’aide de flux{#conversion-feeds}
         ...
         + [Exigences relatives aux fichiers pour les fichiers de flux de conversion](/help/search-social-commerce/tracking/feed-file-requirements.md)
...
+ Gestion de campagne {#campaign-management}
   + Introduction {#campaign-management-intro}
      ...
      + [Données de conversion Google Ads dans Search, Social et Commerce](/help/search-social-commerce/campaign-management/introduction/google-conversion-data.md)
   ...
   + Gestion des campagnes {#management}
      ...
      + Gestion des données dans le [!UICONTROL Campaigns] > [!UICONTROL Campaigns] views {#campaigns}
         + [Créer et modifier des données de campagne en bloc à l’aide de la fonction copier-coller](/help/search-social-commerce/campaign-management/campaigns/copy-paste.md)
         + Campagnes {#campaigns}
      ...
      + Gestion des données en bloc via des feuilles d’envoi groupées {#bulksheets}
         ...
         + Données requises/incluses dans les feuilles d’envoi groupé{#bulksheet-data-formats}
            ...
            + [Données de feuille de support pour [!DNL Yahoo! Display Network] comptes](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-display-network.md)
            + [Données de feuille de support pour [!DNL Yahoo! Japan] comptes](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-japan.md)
...
+ Statistiques et rapports {#insights-reports}
   ...
   + Rapports {#reports}
      ...
      + Gestion des rapports {#report-management}
         ...
         + Aide aux rapports {#assist-reports}
...
+ Administration {#admin}
   ...
   + Configuration des sources de données {#data-sources}
      ...
      + [Configurez une [!DNL Google Analytics] vue en tant que source de données](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
