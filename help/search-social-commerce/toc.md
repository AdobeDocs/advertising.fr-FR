...
+ (Beta) NOUVELLE INTERFACE UTILISATEUR {#new-ui}
   ...
   + Gérer {#manage}
      ...
      + Campagnes {#campaigns}
         ...
         + [Afficher un graphique des performances dans la vue [!UICONTROL Campaigns]](/help/search-social-commerce/new-ui/manage/campaigns/campaign-view-performance-graph.md)
      ...
      + Groupes publicitaires {#ad-groups}
         ...
         + [Afficher un graphique des performances dans la vue [!UICONTROL Ad Groups]](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-view-performance-graph.md)
