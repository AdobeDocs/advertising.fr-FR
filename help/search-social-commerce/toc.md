...
+ Introduction {#intro}
  ...
  + [Politiques et directives (lien)](https://experienceleague.adobe.com/en/docs/advertising/policies/ad-requirements-policy){target="_blank"}
...
+ Tâches courantes {#common-tasks}
  + [Afficher les données pour un autre annonceur](/help/search-social-commerce/common-tasks/change-advertiser.md)
  + [Modifier les paramètres directement dans une ligne](/help/search-social-commerce/common-tasks/settings-edit-within-row.md)
  + Personnaliser les vues de données {#data-views}
    + [À propos de la personnalisation des données dans les vues de gestion de campagne](/help/search-social-commerce/common-tasks/data-views/data-views-about.md)
    + [Gestion des vues par défaut et personnalisées](/help/search-social-commerce/common-tasks/data-views/custom-default-views-manage.md)
    + Paramètres des vues ad hoc {#ad-hoc-settings}
      + [Modifiez le jeu de colonnes à partir du menu d’en-tête de colonne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-column-heading.md)
      + [Modifier et trier le jeu de colonnes à partir de l’icône [!UICONTROL Custom Columns]](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
      + [Verrouiller et déverrouiller une configuration de colonne dans les vues de campagne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-lock-unlock.md)
      + [Réorganiser une colonne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-sort.md)
      + [Filtrer les données par période](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/date-filter.md)
      + [Filtrer les données à l’aide du panneau de navigation de gauche](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/filter-using-left-panel.md)
      + Filtrer les données par valeurs de colonne {#filter-column-values}
        + [Application d’un filtre de données à partir d’un menu d’en-tête de colonne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-filter-apply-from-column-heading.md)
  ...
  + Gestion des mesures personnalisées {#custom-metrics}
    ...
    + [Paramètres de mesure personnalisés](/help/search-social-commerce/common-tasks/custom-metrics/custom-metric-settings.md)
  + Tâches courantes de navigation, de modification et de sélection {#navigation-editing-selection}
    + [Sélectionner plusieurs lignes](/help/search-social-commerce/common-tasks/navigation-editing-selection/multiple-rows-select.md)
...
+ (Beta) NOUVELLE INTERFACE UTILISATEUR {#new-ui}
  ...
  + Gérer {#manage}
    + Portefeuilles {#portfolios}
      ...
      + [Modifier en masse les paramètres de portfolio à l’aide de fichiers de feuille d’envoi groupé](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-bulksheets.md)
      + [Renommer un portfolio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-rename.md)
      + [Modifier le statut d&#39;un portefeuille](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-change-status.md)
      + [Paramètres de Portfolio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-settings.md)
      + [Exécuter une simulation personnalisée à partir de la vue [!UICONTROL Portfolios]](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-create-simulation.md)
      + [Afficher un graphique des performances dans la vue [!UICONTROL Portfolios]](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-view-performance-graph.md)
    ...
    + Campagnes {#campaigns}
      ...
      + Paramètres de la campagne par réseau publicitaire {#campaign-settings-by-network}
        ...
        + [[!DNL LY Ads] des paramètres de la campagne](/help/search-social-commerce/new-ui/manage/campaigns/campaign-settings-yahoo-japan.md)
        ...
        + [[!DNL Yandex] des paramètres de la campagne](/help/search-social-commerce/new-ui/manage/campaigns/campaign-settings-yandex.md)
    + Groupes publicitaires {#ad-groups}
      ...
      + Paramètres des groupes publicitaires par réseau publicitaire {#ad-group-settings-by-network}
        ...
        + [[!DNL LY Ads] paramètres de groupe publicitaire](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-settings-yahoo-japan.md)
        ...
        + [[!DNL Yandex] paramètres de groupe publicitaire](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-settings-yandex.md)
    + Publicités {#ads}
      ...
      + Paramètres publicitaires par réseau publicitaire {#ad-settings-by-network}
        ...
        + [[!DNL Microsoft Advertising] des paramètres de publicité multimédia](/help/search-social-commerce/new-ui/manage/ads/ad-settings-microsoft-multimedia.md)
        + [[!DNL Microsoft Advertising] les paramètres de publicité du produit](/help/search-social-commerce/new-ui/manage/ads/ad-settings-microsoft-product.md)
      ...
      + Types de rapports planifiés {#report-types}
        + Rapports de base et avancés {#basic-advanced-reports}
          ...
          + Formats de rapport de base {#basic-report-formats}
            + [Le [!UICONTROL Ad Group Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/ad-group-report.md)
            + [Le [!UICONTROL Ad Variation Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/ad-variation-report.md)
            + [Le [!UICONTROL Asset Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/asset-report.md)
            + [Le [!UICONTROL Campaign Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/campaign-report.md)
            + [Le [!UICONTROL Campaign Hourly Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/campaign-hourly-report.md)
            + [Le [!UICONTROL Constraint Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/constraint-report.md)
            + [Le [!UICONTROL Keyword Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/keyword-report.md)
            + [Le [!UICONTROL Label Classification Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/label-classification-report.md)
            + [Le [!UICONTROL Label Value Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/label-value-report.md)
            + [Le [!UICONTROL Network Constraint Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/network-constraint-report.md)
            + [Le [!UICONTROL Portfolio Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/portfolio-report.md)
            ...
            + [Le [!UICONTROL Search Engine Account Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/search-engine-account-report.md)
            + [Le [!UICONTROL Search Engine Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/search-engine-report.md)
          + Formats de rapports avancés {#advanced-report-formats}
            + [Le [!UICONTROL Domain Referral Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/domain-referral-report.md)
            + [Le [!UICONTROL Geo Distribution Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/geo-distribution-report.md)
            + [Le [!UICONTROL Transaction Report]](/help/search-social-commerce/new-ui/reports/management/basic-advanced/transaction-report.md)
          + [Paramètres de rapport de base et avancés](/help/search-social-commerce/new-ui/reports/management/basic-advanced/basic-advanced-report-settings.md)
        ...
        + Rapports spécialisés {#specialty-reports}
          ...
          + Formats de rapports spécialisés {#specialty-report-formats}
            + [Le [!UICONTROL AdWords and Bing Audience Target Report]](/help/search-social-commerce/new-ui/reports/management/specialty/adwords-bing-audience-target-report.md)
            + [Le [!UICONTROL AdWords Conversion Report]](/help/search-social-commerce/new-ui/reports/management/specialty/adwords-conversion-report.md)
            + [Le [!UICONTROL AdWords Geo Report]](/help/search-social-commerce/new-ui/reports/management/specialty/adwords-geo-report.md)
            + [Le [!UICONTROL AdWords Search Query Report]](/help/search-social-commerce/new-ui/reports/management/specialty/adwords-search-query-report.md)
            + [Le [!UICONTROL AdWords Shopping Performance Report]](/help/search-social-commerce/new-ui/reports/management/specialty/adwords-shopping-performance-report.md)
            + [Le [!UICONTROL Bing Ads Geo Report]](/help/search-social-commerce/new-ui/reports/management/specialty/bing-ads-geo-report.md)
            + [Le [!UICONTROL Bing Ads Search Query Report]](/help/search-social-commerce/new-ui/reports/management/specialty/bing-ads-search-query-report.md)
            + [Le [!UICONTROL Campaign Daily Impression Share Report]](/help/search-social-commerce/new-ui/reports/management/specialty/campaign-daily-impression-share-report.md)
            + [Le [!UICONTROL Google AI Max Search Term Combination Report]](/help/search-social-commerce/new-ui/reports/management/specialty/google-ai-max-search-term-combination-report.md)
            + [Le [!UICONTROL Google Asset Group Performance Report]](/help/search-social-commerce/new-ui/reports/management/specialty/google-asset-group-performance-report.md)
            + [Le [!UICONTROL Google Performance Max Placement Report]](/help/search-social-commerce/new-ui/reports/management/specialty/google-performance-max-placement-report.md)
            + [Le [!UICONTROL Keyword Daily Impression Share Report]](/help/search-social-commerce/new-ui/reports/management/specialty/keyword-daily-impression-share-report.md)
            + [Le [!UICONTROL RSA Asset Report]](/help/search-social-commerce/new-ui/reports/management/specialty/rsa-asset-report.md)
            + [Le [!UICONTROL MSA Ad Extension by Ad Report]](/help/search-social-commerce/new-ui/reports/management/specialty/msa-ad-extension-detail-report.md)
            + [Le [!UICONTROL MSA Ad Extension by Keyword Report]](/help/search-social-commerce/new-ui/reports/management/specialty/msa-ad-extension-by-keyword-report.md)
            + [Le [!UICONTROL MSA Ad Extension Detail Report]](/help/search-social-commerce/new-ui/reports/management/specialty/msa-ad-extension-by-ad-report.md)
            + [Le [!UICONTROL MSA Network Impression Share Report]](/help/search-social-commerce/new-ui/reports/management/specialty/msa-network-impression-share-report.md)
            + [Le [!UICONTROL MSA Network Performance Report]](/help/search-social-commerce/new-ui/reports/management/specialty/msa-network-performance-report.md)
          + [Paramètres des rapports spécialisés](/help/search-social-commerce/new-ui/reports/management/specialty/specialty-report-settings.md)
          + [Colonnes de rapports pour les rapports spécialisés](/help/search-social-commerce/new-ui/reports/management//specialty/specialty-report-columns.md)
        + Rapports de précision du modèle {#model-accuracy-reports}
          + [À propos des rapports de précision de modèle](/help/search-social-commerce/new-ui/reports/management/model-accuracy/model-accuracy-report-about.md)
          + Formats de rapport de précision du modèle {#assist-report-formats}
            + [Le [!UICONTROL Forecast Accuracy Report]](/help/search-social-commerce/new-ui/reports/management/model-accuracy/forecast-accuracy-report.md)
            + [Le [!UICONTROL Forecast Accuracy (Actuals) Report]](/help/search-social-commerce/new-ui/reports/management/model-accuracy/forecast-accuracy-actuals-report.md)
...
+ Tracking {#tracking}
  ...
  + Suivi des clics {#click-tracking}
    ...
    + Composants des URL de suivi des clics {#click-tracking-components}
      + Formats standard des URL de suivi des clics {#click-tracking-formats}
        + [À propos des formats d’URL de suivi des clics](/help/search-social-commerce/tracking/formats-click-tracking-about.md)
        + [Formats de suivi des clics pour  [!DNL Baidu]](/help/search-social-commerce/tracking/formats-click-tracking-baidu.md)
        + [Formats de suivi des clics pour  [!DNL Google Ads]](/help/search-social-commerce/tracking/formats-click-tracking-google.md)
  ...
  + Suivi des conversions {#conversion-tracking}
    ...
    + Suivi des conversions Adobe Advertising {#advertising-conversion-tracking}
      ...
      + [Questions fréquentes sur la conversion et les balises de suivi des pages vues](/help/search-social-commerce/tracking/faqs-conversion-page-view-tracking-tags.md)
    + [Suivi des conversions Adobe Analytics](/help/search-social-commerce/tracking/conversion-tracking-analytics.md)
    + Conversions suivies par l’annonceur à l’aide de flux{#conversion-feeds}
      + Flux utilisant des ID d’éléments d’expérience {#ef-ids}
        + [Suivi des conversions à l’aide d’un flux d’ID d’EF](/help/search-social-commerce/tracking/feed-efid.md)
      ...
      + Flux utilisant des ID de transaction {#transaction-ids}
      ...
      + [Exigences relatives aux fichiers de flux de conversion](/help/search-social-commerce/tracking/feed-file-requirements.md)
  + [Questions fréquentes sur le tracking](/help/search-social-commerce/tracking/faqs-tracking.md)
+ Gestion des campagnes {#campaign-management}
  + Introduction {#campaign-management-intro}
    + [À propos de la gestion des campagnes dans Search, Social et Commerce](/help/search-social-commerce/campaign-management/introduction/campaign-management-about.md)
    + [Présentation de l’implémentation des comptes et des campagnes de réseau publicitaire](/help/search-social-commerce/campaign-management/introduction/campaign-implemention-overview.md)
    + [Surveiller et gérer les performances de vos campagnes réseau publicitaire](/help/search-social-commerce/campaign-management/introduction/monitor-performance-campaigns.md)
    + [[!DNL Google Ads] des données de conversion dans Search, Social et Commerce](/help/search-social-commerce/campaign-management/introduction/google-conversion-data.md)
    + [[!DNL Microsoft Advertising] des données de conversion dans Search, Social et Commerce](/help/search-social-commerce/campaign-management/introduction/microsoft-conversion-data.md)
  ...
  + Gestion des campagnes {#management}
    ...
    + Gestion des données dans les vues [!UICONTROL Campaigns] > [!UICONTROL Campaigns] {#campaigns}
      ...
      + Mots-clés {#keywords}
        ...
        + Paramètres des mots-clés par réseau publicitaire {#keyword-settings-by-network}
          + [Paramètres des mots-clés [!DNL Baidu]](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-baidu.md)
          + [Paramètres des mots-clés [!DNL Google Ads]](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-google.md)
          + [Paramètres des mots-clés [!DNL LY Ads]](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)
          + [Paramètres des mots-clés [!DNL Microsoft Advertising]](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-microsoft.md)
          + [Paramètres des mots-clés [!DNL Yandex]](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yandex.md)
      + Publicités {#ads}
        + [À propos des publicités](/help/search-social-commerce/campaign-management/campaigns/ad-about.md)
        + [Gestion des publicités](/help/search-social-commerce/campaign-management/campaigns/ad-manage.md)
        + Paramètres publicitaires par réseau publicitaire {#ad-settings-by-network}
          + [[!DNL Baidu] les paramètres d’annonces de texte](/help/search-social-commerce/campaign-management/campaigns/ad-settings-baidu-text.md)
          + [[!DNL Google Ads] des paramètres de publicité d’appel uniquement](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-call.md)
          + [[!DNL Google Ads] des paramètres d’annonce de recherche dynamique étendus](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-dsa.md)
          + [[!DNL Google Ads] des paramètres des annonces de recherches réactives](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-rsa.md)
          + [[!DNL Microsoft Advertising] des paramètres d’annonce de recherche dynamique étendus](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-dsa.md)
          + [[!DNL Microsoft Advertising] des paramètres de publicité multimédia](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-multimedia.md)
          + [[!DNL Microsoft Advertising] les paramètres de publicité du produit](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-product.md)
          + [[!DNL Microsoft Advertising] des paramètres d’annonce publicitaire réactifs (audience)](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
          + [[!DNL Microsoft Advertising] des paramètres des annonces de recherches réactives](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-rsa.md)
          + [[!DNL Yandex] les paramètres d’annonces de texte](/help/search-social-commerce/campaign-management/campaigns/ad-settings-yandex-text.md)
      + Groupes de produits {#product-groups}
        + [À propos des groupes de produits](/help/search-social-commerce/campaign-management/campaigns/product-group-about.md)
        + [Gestion des groupes de produits](/help/search-social-commerce/campaign-management/campaigns/product-group-manage.md)
        + [[!DNL Google Ads] des paramètres de groupe de produits](/help/search-social-commerce/campaign-management/campaigns/product-group-settings-google.md)
        + [[!DNL Microsoft Advertising] des paramètres de groupe de produits](/help/search-social-commerce/campaign-management/campaigns/product-group-settings-microsoft.md)
      ...
      + Stages {#placements}
        + [À propos des emplacements](/help/search-social-commerce/campaign-management/campaigns/placement-about.md)
        + [Gérer les emplacements pouvant faire l’objet d’offres](/help/search-social-commerce/campaign-management/campaigns/placement-manage.md)
        + [Créer des emplacements négatifs](/help/search-social-commerce/campaign-management/campaigns/placement-negative-create.md)
        + [Modifier le statut des emplacements et des emplacements négatifs](/help/search-social-commerce/campaign-management/campaigns/placement-status-edit.md)
      + Cibles automatiques {#auto-targets}
        + [À propos  [!DNL Google Ads]  cibles de recherche dynamique](/help/search-social-commerce/campaign-management/campaigns/dynamic-search-target-about.md)
        + [Gestion  [!DNL Google Ads]  cibles de recherche dynamiques](/help/search-social-commerce/campaign-management/campaigns/dynamic-search-target-manage.md)
      + Audiences et cibles d’audience {#audiences-and-targets}
        + Audiences {#audiences}
          ...
          + Cibles d’audience et exclusions {#audience-targets}
    ...
    + Automatisation des données de campagne à l’aide de flux d’inventaire {#inventory-feeds}
      ...
      + [Configurer les paramètres des données de flux](/help/search-social-commerce/campaign-management/inventory-feeds/feed-settings-manage.md)
      ...
      + Modèles {#feed-templates}
        + [Gestion des modèles de publicité](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/ad-template-manage.md)
        + [Paramètres d’annonce textuelle et de modèle d’annonce responsive sur le Réseau de recherche](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-text-rsa.md)
        + [[!DNL Google Ads] des paramètres de modèle d’annonce publicitaire](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-google-shopping.md)
        + [[!DNL Microsoft Advertising] des paramètres de modèle d’annonce publicitaire](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-microsoft-shopping.md)
      ...
      + Utilisation des données de campagne créées à partir de flux {#propagated-data}
        + [Afficher les données générées à partir des flux](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-view.md)
        + [Modifier les données générées à partir des flux](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-edit.md)
        + [Publier les données de campagne générées à partir des flux sur les réseaux publicitaires](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-post.md)
        + [Arrêter un traitement de validation des données de flux de stock](/help/search-social-commerce/campaign-management/inventory-feeds/stop-job.md)
        + [Statuts des données générées à partir des flux](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-status.md)
    + Mise en œuvre de campagnes, d’annonces et de conversions avec des workflows uniques{#special-workflows}
      ...
      + [Implémenter  [!DNL Google Ads]  publicités de recherche dynamiques](/help/search-social-commerce/campaign-management/special-workflows/google-dynamic-search-ads.md)
      + [Implémenter  [!DNL Google Ads]  campagnes de performances maximales](/help/search-social-commerce/campaign-management/special-workflows/google-performance-max-campaigns.md)
      + [Implémenter  [!DNL Google Ads]  campagnes d’achat](/help/search-social-commerce/campaign-management/special-workflows/google-shopping-campaigns.md)
      + [Implémenter  [!DNL Microsoft Advertising]  conversions améliorées pour les conversions hors ligne](/help/search-social-commerce/campaign-management/special-workflows/microsoft-enhanced-conversions.md)
      + [Implémenter  [!DNL Microsoft Advertising]  campagnes d’achat](/help/search-social-commerce/campaign-management/special-workflows/microsoft-shopping-campaigns.md)
    + [Synchronisation manuelle des données réseau et](/help/search-social-commerce/campaign-management/campaigns/sync-network.md)
  ...
  + Gestion des classifications de libellés {#label-classifications}
    + [À propos des classifications de libellés](/help/search-social-commerce/campaign-management/label-classifications/classification-about.md)
    + [Créer une classification de libellé](/help/search-social-commerce/campaign-management/label-classifications/classification-create.md)
    + [Attribuer des valeurs de classification aux composants de compte à partir des vues de gestion de campagne](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management.md)
    + [Affectation de valeurs de classification à des composants de compte à l’aide de feuilles d’envoi groupé](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets.md)
    + [Supprimer les valeurs de classification de libellé des composants de compte](/help/search-social-commerce/campaign-management/label-classifications/classification-values-remove.md)
    + [Supprimer les valeurs de classification de libellé](/help/search-social-commerce/campaign-management/label-classifications/classification-values-delete.md)
    + [Supprimer les classifications de libellés](/help/search-social-commerce/campaign-management/label-classifications/classification-delete.md)
  ...
  + Bonnes pratiques relatives aux campagnes de recherche {#best-practices-search}
    + [Analyse des rapports pour affiner les mots-clés et les paramètres de la campagne](/help/search-social-commerce/campaign-management/best-practices/best-practices-analyze.md)
    + [Rédiger du texte et le copier efficacement](/help/search-social-commerce/campaign-management/best-practices/best-practices-write.md)
    + [Optimisation des pages de destination du site web](/help/search-social-commerce/campaign-management/best-practices/best-practices-optimize.md)
  ...
  + [Questions fréquentes sur la gestion de campagnes](/help/search-social-commerce/campaign-management/faqs-campaigns.md)
+ Informations et rapports {#insights-reports}
  + Advertising Insights {#insights}
    + [À propos des [!UICONTROL Advertising Insights]](/help/search-social-commerce/advertising-insights/insight-about.md)
    + [Générer un  [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-generate.md)
    + [Afficher ou enregistrer un  [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-view-save.md)
    + [Supprimer un  [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-delete.md)
  + Rapports {#reports}
    + [Rapports](/help/search-social-commerce/reports/report-about.md)
    + [Tâches de configuration initiales pour les rapports](/help/search-social-commerce/reports/initial-setup.md)
    ...
    + Gestion des rapports {#report-management}
      ...
      + Rapports d’assistance {#assist-reports}
        + [À propos des rapports d’assistance](/help/search-social-commerce/reports/management/assist/assist-report-about.md)
        + Assister les formats de rapport {#assist-report-formats}
        ...
        + [Paramètres des rapports d’assistance](/help/search-social-commerce/reports/management/assist/assist-report-settings.md)
      + Rapports spécialisés {#specialty-reports}
        ...
        + Formats de rapports spécialisés {#specialty-report-formats}
          ...
          + [Le [!UICONTROL Google AI Max Search Term Combination Report]](/help/search-social-commerce/reports/management/specialty/google-ai-max-search-term-combination-report.md)
          + [Le [!UICONTROL Google Asset Group Performance Report]](/help/search-social-commerce/reports/management/specialty/google-asset-group-performance-report.md)
          + [Le [!UICONTROL Google Performance Max Placement Report]](/help/search-social-commerce/reports/management/specialty/google-performance-max-placement-report.md)
          ...
          + [Le [!UICONTROL MSA Network Impression Share Report]](/help/search-social-commerce/reports/management/specialty/msa-network-impression-share-report.md)
          + [Le [!UICONTROL MSA Network Performance Report]](/help/search-social-commerce/reports/management/specialty/msa-network-performance-report.md)
    ...
    + Automatisation des rapports {#report-automation}
      + Modèles de rapport {#report-templates}
        + [À propos des modèles de rapport](/help/search-social-commerce/reports/automation/templates/template-about.md)
        + [Affichage d’un modèle de rapport](/help/search-social-commerce/reports/automation/templates/template-view.md)
        + [Création d’un modèle de rapport](/help/search-social-commerce/reports/automation/templates/template-create.md)
        + [Modification d’un modèle de rapport](/help/search-social-commerce/reports/automation/templates/template-edit.md)
        + [Suppression d’un modèle de rapport](/help/search-social-commerce/reports/automation/templates/template-delete.md)
      + Flux de feuilles de calcul {#spreadsheet-feeds}
        + [À propos des flux de rapports de feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-about.md)
        + [Création d [!DNL Excel] un modèle pour un flux de rapports de feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
        + [Créer un flux de rapports de feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create.md)
        + [Modifier les paramètres du flux de rapports d&#39;une feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-edit.md)
        + [Actualiser manuellement les flux de rapports de feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-refresh.md)
        + [Afficher ou enregistrer un fichier de flux de rapports de feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-view-or-save.md)
        + [Supprimer les flux de rapports de feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-delete.md)
        + [Paramètres de flux de rapports des feuilles de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-settings.md)
    ...
    + [Questions fréquentes sur les rapports personnalisés](/help/search-social-commerce/reports/faqs-report.md)
  + Notifications {#notifications}
    + [À propos des notifications](/help/search-social-commerce/notifications/notification-about.md)
    + [Affichage des notifications](/help/search-social-commerce/notifications/notification-view.md)
    + [Marquer une notification comme lue ou non lue](/help/search-social-commerce/notifications/notification-mark-read-unread.md)
    + [Supprimer une notification](/help/search-social-commerce/notifications/notification-delete.md)
    + [Modifier vos paramètres de notification](/help/search-social-commerce/notifications/notification-edit.md)
    + [Activer et désactiver les notifications push depuis [!UICONTROL Notification Center]](/help/search-social-commerce/notifications/notifications-push-enable-disable.md)
    + [Installation et désinstallation de l’application web [!UICONTROL Notification Center]](/help/search-social-commerce/notifications/notification-app-install-uninstall.md)
  + Alertes personnalisées {#alerts}
    + [À propos des alertes personnalisées](/help/search-social-commerce/alerts/alert-about.md)
    + Modèles d’alerte {#alert-templates}
      + [Création d’un modèle d’alerte personnalisé](/help/search-social-commerce/alerts/alert-template-create.md)
      + [Modification d’un modèle d’alerte personnalisé](/help/search-social-commerce/alerts/alert-template-edit.md)
      + [Mettre en pause un modèle d’alerte personnalisé](/help/search-social-commerce/alerts/alert-template-pause.md)
      + [Activation d’un modèle d’alerte personnalisé](/help/search-social-commerce/alerts/alert-template-activate.md)
      + [Suppression d’un modèle d’alerte personnalisé](/help/search-social-commerce/alerts/alert-template-delete.md)
      + [Paramètres du modèle d’alerte personnalisé](/help/search-social-commerce/alerts/alert-template-settings.md)
    + [Affichage des alertes personnalisées](/help/search-social-commerce/alerts/alert-view.md)
    + [Exporter les données pour les alertes personnalisées](/help/search-social-commerce/alerts/alert-export-data.md)
  + [Afficher le rapport Historique des modifications](/help/search-social-commerce/reports/change-history-view.md)
  + Recommandations et informations sur l’éditeur {#recommendations}
    + [À propos de la prise en charge des recommandations et informations de l’éditeur](/help/search-social-commerce/recommendations/recommendation-support.md)
    + [Afficher les recommandations et les informations sur les performances de votre éditeur](/help/search-social-commerce/recommendations/recommendation-view.md)
    + [Appliquer ou ignorer une recommandation de l’éditeur](/help/search-social-commerce/recommendations/recommendation-apply-dismiss.md)
    + [Afficher le journal des recommandations de l’éditeur pour un compte](/help/search-social-commerce/recommendations/recommendation-view-log.md)
    + [Bonnes pratiques relatives à l’utilisation des recommandations de l’éditeur avec les portfolios](/help/search-social-commerce/recommendations/recommendation-best-practices.md)
+ Outils {#tools}
  + [Modifier votre mot de passe](/help/search-social-commerce/tools/password-change.md)
  + Outils de création et de décodage des balises de tracking{#tracking}
    + [À propos des outils de création et de décodage des balises de tracking](/help/search-social-commerce/tools/tracking-tools-about.md)
    + [Générer une URL de tracking des clics](/help/search-social-commerce/tools/click-tracking-url-generate.md)
    + [Décodage d’une URL de suivi des clics](/help/search-social-commerce/tools/click-tracking-url-decode.md)
    + [Génération et implémentation d’une balise de conversion Adobe Advertising](/help/search-social-commerce/tools/conversion-tag-generate.md)
  + Chargement des données de conversion vers les réseaux publicitaires {#upload-ad-networks}
    + [Chargez les mesures de conversion suivies par Search, Social et Commerce vers  [!DNL Google Ads]](/help/search-social-commerce/tools/conversion-metrics-upload-to-google.md)
  ...
  + Chargement de mesures pour les comptes de suivi [!DNL Naver] uniquement {#generic-tracking}
    ...
    + [Exigences en matière de données de mesure pour les comptes  [!DNL Naver]  suivi uniquement](/help/search-social-commerce/tools/metrics-upload-tracking-campaigns/naver-tracking-campaigns-data-requirements.md)
  + [Activer la synchronisation d&#39;inventaire supplémentaire](/help/search-social-commerce/tools/sync-inventory.md)
...
+ Administration {#admin}
  + [À propos des rôles](/help/search-social-commerce/admin/role-about.md)
  + [Gestion des informations d’identification pour les comptes du gestionnaire de réseau publicitaire](/help/search-social-commerce/admin/manager-accounts.md)
  ...
  + Configuration des sources de données {#data-sources}
    + [À propos de la synchronisation [!DNL Google Analytics] des mesures de conversion](/help/search-social-commerce/admin/data-sources/data-source-about.md)
    + [Conditions préalables à la configuration d’une source  [!DNL Google Analytics]  données](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
    + [Configurer une  [!DNL Google Analytics]  en tant que source de données](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
    + [Modifier une source  [!DNL Google Analytics]  données](/help/search-social-commerce/admin/data-sources/data-source-edit.md)
    + [Suspendre la synchronisation d’une source de données](/help/search-social-commerce/admin/data-sources/data-source-pause.md)
    + [Réauthentifier une source  [!DNL Google Analytics]  données](/help/search-social-commerce/admin/data-sources/data-source-reauthenticate.md)
    + [[!DNL Google Analytics] des paramètres des sources de données](/help/search-social-commerce/admin/data-sources/data-source-settings.md)
    + [Annexe - Mesures  [!DNL Google Analytics]  disponibles](/help/search-social-commerce/admin/data-sources/data-source-ga-metrics.md)
  + Gestion des mesures de conversion d’un annonceur{#conversion-metrics}
    ...
    + Gestion des balises de conversion et des actions/objectifs de conversion spécifiques au réseau publicitaire {#network-conversions}
      + [Créez une balise de conversion pour  [!DNL Google Ads]](/help/search-social-commerce/admin/conversion-metrics/conversion-tag-google.md)
