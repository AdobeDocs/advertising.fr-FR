...
+ (Beta) NOUVELLE INTERFACE UTILISATEUR {#new-ui}
   ...
   + Plan {#plan}
      + Objectifs {#objectives}
         + [À propos des objectifs](/help/search-social-commerce/new-ui/plan/objectives/objective-about.md)
         + [Création d’un objectif](/help/search-social-commerce/new-ui/plan/objectives/objective-create.md)
         + [Modification d’un objectif](/help/search-social-commerce/new-ui/plan/objectives/objective-edit.md)
         + [Supprimer un objectif](/help/search-social-commerce/new-ui/plan/objectives/objective-delete.md)
         + [Appliquer des recommandations de poids à un objectif](/help/search-social-commerce/new-ui/plan/objectives/objective-apply-weight-recommendations.md)
         + [Paramètres des objectifs](/help/search-social-commerce/new-ui/plan/objectives/objective-settings.md)
