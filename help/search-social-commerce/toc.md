...
+ Introduction {#intro}
   ...
   + Intégration à Adobe Experience Cloud {#integrations}
      ...
      + [Adobe [!DNL Analytics for Advertising] (lien)](https://experienceleague.adobe.com/docs/advertising/integrations/analytics/overview.html?lang=fr){target="_blank"}
      + [Intégration à Adobe Audience Manager (lien)](https://experienceleague.adobe.com/docs/advertising/integrations/audience-manager/overview.html?lang=fr){target="_blank"}
   + [Prise en charge de la confidentialité des consommateurs (lien)](https://experienceleague.adobe.com/docs/advertising/privacy/home.html?lang=fr){target="_blank"}
   + [Stratégies et directives (lien)](https://experienceleague.adobe.com/docs/advertising/policies/ad-requirements-policy.html?lang=fr){target="_blank"}
...
+ Tâches courantes {#common-tasks}
   ...
   + Personnalisation des vues de données {#data-views}
      ...
      + Paramètres des vues ad hoc {#ad-hoc-settings}
         ...
         + [Modifiez et triez l’ensemble de colonnes à partir de l’icône [!UICONTROL Custom Columns]](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
   ...
   + Tâches courantes de navigation, d’édition et de sélection {#navigation-editing-selection}
      ...
      + Télécharger des données dans les vues de gestion {#download-data-views}
         ...
         + [Supprimez un rapport de données de performances ou un fichier de feuille d’envoi groupé du menu [!UICONTROL Downloads].](/help/search-social-commerce/common-tasks/navigation-editing-selection/download-delete-data.md)
+ Tracking {#tracking}
   ...
   + Suivi des clics {#click-tracking}
      ...
      + [Adobe Advertising des cookies (lien)](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-advertising-cloud.html?lang=fr){target="_blank"}
   ...
   + Suivi des conversions {#conversion-tracking}
      ...
      + Adobe Advertising du suivi des conversions {#advertising-conversion-tracking}
...
+ Gestion de campagne {#campaign-management}
   ...
   + [Mise en oeuvre de  [!DNL Naver]  comptes de suivi uniquement](/help/search-social-commerce/campaign-management/naver-tracking-only-account-implement.md)
   + Gestion des campagnes {#management}
      ...
      + Gestion des données dans les [!UICONTROL Campaigns] > [!UICONTROL Campaigns] vues {#campaigns}
         ...
         + Campagnes {#campaigns}
            ...
            + Paramètres de campagne par réseau publicitaire {#campaign-settings-by-network}
         ...
         + Publicités {#ads}
            ...
            + Paramètres des publicités par réseau publicitaire {#ad-settings-by-network}
               ...
               + [[!DNL Google Ads] paramètres de publicité d’appel uniquement](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-call.md)
               ...
               + [Paramètres de publicité [!DNL Microsoft Advertising] réactive (audience)](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
         ...
         + Cibles automatiques {#auto-targets}
            + [A propos des  [!DNL Google Ads] cibles de recherche dynamique](/help/search-social-commerce/campaign-management/campaigns/dynamic-search-target-about.md)
            + [Gérer les  [!DNL Google Ads] cibles de recherche dynamique](/help/search-social-commerce/campaign-management/campaigns/dynamic-search-target-manage.md)
         + Audiences et cibles d’audience {#audiences-and-targets}
            + Audiences {#audiences}
               ...
               + [Créer [!DNL Google Ads] des audiences de correspondance client à partir d&#39;audiences  [!DNL Adobe] ](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-adobe-audience.md)
               + [Création d’une audience de correspondance de client  [!DNL Google Ads] à partir d’une liste de messagerie Adobe Campaign](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-campaign-email-list.md)
         ...
         + Extensions d’annonce {#ad-extensions}
            + [!DNL Google Ads] extensions de légende {#callouts}
               + [À propos des  [!DNL Google Ads] extensions de légende](/help/search-social-commerce/campaign-management/campaigns/callout-extension-about.md)
               + [Gérer les extensions d’appel  [!DNL Google Ads] ](/help/search-social-commerce/campaign-management/campaigns/callout-extension-manage.md)
               + [Associer [!DNL Google Ads] des extensions de légende partagée à des campagnes ou des groupes publicitaires](/help/search-social-commerce/campaign-management/campaigns/callout-extension-associate.md)
            + Extensions Lien de site {#sitelinks}
      ...
      + Automatisation des données de campagne à l’aide de flux d’inventaire {#inventory-feeds}
         ...
         + Modèles {#feed-templates}
            ...
            + [[!DNL Google Ads] paramètres du modèle de publicité d’achat](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-google-shopping.md)
            + [[!DNL Microsoft Advertising] paramètres du modèle de publicité d’achat](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-microsoft-shopping.md)
      ...
      + Mise en oeuvre de campagnes, de publicités et de conversions avec des workflows uniques{#special-workflows}
         + [Mise en oeuvre de [!DNL Google Ads] conversions améliorées pour les pistes](/help/search-social-commerce/campaign-management/special-workflows/google-enhanced-conversions-leads.md)
   ...
   + Bonnes pratiques pour les campagnes de recherche {#best-practices-search}
...
+ Statistiques et rapports {#insights-reports}
   + Advertising Insights {#insights}
      + [À propos de [!UICONTROL Advertising Insights]](/help/search-social-commerce/advertising-insights/insight-about.md)
   ...
   + Rapports {#reports}
      ...
      + Gestion des rapports {#report-management}
         ...
         + Aide aux rapports {#assist-reports}
            ...
            + Aider les formats de rapports {#assist-report-formats}
         ...
         + Rapports de précision des modèles {#model-accuracy-reports}
            ...
            + Formats de rapports de précision des modèles {#assist-report-formats}
