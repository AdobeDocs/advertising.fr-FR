...
+ Introduction {#intro}
   ...
   + [Prise en charge de la confidentialité des utilisateurs (lien)](https://experienceleague.adobe.com/docs/advertising/privacy/home.html){target="_blank"}
   + [Stratégies et directives (lien)](https://experienceleague.adobe.com/docs/advertising/policies/ad-requirements-policy.html){target="_blank"}
...
+ Tâches courantes {#common-tasks}
   + [Afficher les données d’un autre annonceur](/help/search-social-commerce/common-tasks/change-advertiser.md)
   + [Modifier les paramètres directement dans une ligne](/help/search-social-commerce/common-tasks/settings-edit-within-row.md)
   + Personnalisation des vues de données {#data-views}
      + [A propos de la personnalisation des données dans les vues de gestion de campagne](/help/search-social-commerce/common-tasks/data-views/data-views-about.md)
      ...
      + Paramètres d’affichage ad hoc {#ad-hoc-settings}
         + [Modifier le jeu de colonnes dans le menu d’en-tête de colonne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-column-heading.md)
         + [Modifiez et triez le jeu de colonnes à partir du [!UICONTROL Custom Columns] icon](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
         + [Verrouillage et déverrouillage d’une configuration de colonne dans les vues de campagne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-lock-unlock.md)
         + [Réorganiser une colonne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-sort.md)
         + [Filtrage des données par période](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/date-filter.md)
         + [Filtrage des données à l’aide du panneau de navigation de gauche](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/filter-using-left-panel.md)
         + Filtrage des données par valeurs de colonne {#filter-column-values}
   ...
   + Tâches courantes de navigation, de modification et de sélection {#navigation-editing-selection}
      ...
      + [Définition d’une date à l’aide du calendrier](/help/search-social-commerce/common-tasks/navigation-editing-selection/calendar.md)
      + [Afficher et masquer un graphique des tendances](/help/search-social-commerce/common-tasks/navigation-editing-selection/trend-chard-show-hide.md)
      + [Actualisation des données dans les vues de gestion](/help/search-social-commerce/common-tasks/navigation-editing-selection/refresh.md)
      + Téléchargement des données dans les vues de gestion {#download-data-views}
...
+ Tracking {#tracking}
   + [A propos du tracking](/help/search-social-commerce/tracking/tracking-about.md)
   + Suivi des clics {#click-tracking}
      ...
      + Composants des URL de suivi des clics {#click-tracking-components}
         + Formats standard pour les URL de suivi des clics {#click-tracking-formats}
            + [A propos des formats d’URL de suivi des clics](/help/search-social-commerce/tracking/formats-click-tracking-about.md)
   ...
   + Suivi des conversions {#conversion-tracking}
      ...
      + Conversions suivies par les annonceurs à l’aide de flux{#conversion-feeds}
         + Flux utilisant des ID EF {#ef-ids}
         ...
         + [Exigences liées aux fichiers de flux de conversion](/help/search-social-commerce/tracking/feed-file-requirements.md)
...
+ Gestion de campagne {#campaign-management}
   + Introduction {#campaign-management-intro}
      ...
      + [[!DNL Microsoft Advertising] données de conversion dans Search, Social et Commerce](/help/search-social-commerce/campaign-management/introduction/microsoft-conversion-data.md)
   + Configuration de comptes {#campaign-management-accounts}
   ...
   + Gestion des campagnes {#management}
      + [Options de gestion des campagnes publicitaires réseau](/help/search-social-commerce/campaign-management/campaigns/campaign-management-options.md)
      + Gestion des données dans le [!UICONTROL Campaigns] > [!UICONTROL Campaigns] views {#campaigns}
         ...
         + Campagnes {#campaigns}
            ...
            + Paramètres des campagnes par réseau publicitaire {#campaign-settings-by-network}
         ...
         + Mots-clés {#keywords}
            ...
            + Paramètres des mots-clés par réseau publicitaire {#keyword-settings-by-network}
               + [[!DNL Baidu] paramètres de mots-clés](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-baidu.md)
               + [[!DNL Google Ads] paramètres de mots-clés](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-google.md)
               + [[!DNL Microsoft Advertising] paramètres de mots-clés](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-microsoft.md)
               + [[!DNL Yahoo! Japan Ads] paramètres de mots-clés](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)
               + [[!DNL Yandex] paramètres de mots-clés](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yandex.md)
         + Publicités {#ads}
            + [A propos des publicités](/help/search-social-commerce/campaign-management/campaigns/ad-about.md)
            + [Gestion des publicités](/help/search-social-commerce/campaign-management/campaigns/ad-manage.md)
            + Paramètres des publicités par réseau publicitaire {#ad-settings-by-network}
               + [[!DNL Baidu] paramètres de publicité texte](/help/search-social-commerce/campaign-management/campaigns/ad-settings-baidu-text.md)
               + [[!DNL Google Ads] paramètres d’annonce d’appel uniquement](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-call.md)
               + [[!DNL Google Ads] paramètres d’annonce de recherche dynamique étendus](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-dsa.md)
               + [[!DNL Google Ads] paramètres de publicité de recherche réactive](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-rsa.md)
               + [[!DNL Microsoft Advertising] paramètres d’annonce de recherche dynamique étendus](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-dsa.md)
               + [[!DNL Microsoft Advertising] paramètres de publicité multimédia](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-multimedia.md)
               + [[!DNL Microsoft Advertising] paramètres de publicité de produit](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-product.md)
               + [[!DNL Microsoft Advertising] paramètres de publicité réactive (audience)](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
               + [[!DNL Microsoft Advertising] paramètres de publicité de recherche réactive](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-rsa.md)
               + [[!DNL Yandex] paramètres de publicité texte](/help/search-social-commerce/campaign-management/campaigns/ad-settings-yandex-text.md)
         + Groupes de produits {#product-groups}
            + [Groupes de produits](/help/search-social-commerce/campaign-management/campaigns/product-group-about.md)
            + [Gestion des groupes de produits](/help/search-social-commerce/campaign-management/campaigns/product-group-manage.md)
            + [Paramètres du groupe de produits Google Ads](/help/search-social-commerce/campaign-management/campaigns/product-group-settings-google.md)
            + [Paramètres du groupe de produits Microsoft Advertising](/help/search-social-commerce/campaign-management/campaigns/product-group-settings-microsoft.md)
         ...
         + Emplacements {#placements}
            ...
            + [Gérer les emplacements pouvant faire l&#39;objet d&#39;un offre](/help/search-social-commerce/campaign-management/campaigns/placement-manage.md)
            + [Créer des emplacements négatifs](/help/search-social-commerce/campaign-management/campaigns/placement-negative-create.md)
            + [Modifier l’état des emplacements et des emplacements négatifs](/help/search-social-commerce/campaign-management/campaigns/placement-status-edit.md)
         + Ciblages automatiques {#auto-targets}
            + [A propos [!DNL Google Ads] cibles de recherche dynamique](/help/search-social-commerce/campaign-management/campaigns/dynamic-search-target-about.md)
            + [Gérer [!DNL Google Ads] cibles de recherche dynamique](/help/search-social-commerce/campaign-management/campaigns/dynamic-search-target-manage.md)
         + Audiences et cibles d’audience {#audiences-and-targets}
            + Audiences {#audiences}
               ...
               + [Créer [!DNL Google Ads] audiences de correspondance client provenant de [!DNL Adobe] audiences](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-adobe-audience.md)
               + [Créez un [!DNL Google Ads] audience de correspondance client provenant d’une liste de messagerie Adobe Campaign](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-campaign-email-list.md)
               + [Gestion des audiences de correspondance client à l’aide des listes de données client](/help/search-social-commerce/campaign-management/campaigns/audience-from-customer-data-list.md)
               ...
               + Cibles et exclusions d’audience {#audience-targets}
         ...
         + Extensions publicitaires {#ad-extensions}
            + [!DNL Google Ads] Extensions de légende {#callouts}
               + [A propos [!DNL Google Ads] Extensions de légende](/help/search-social-commerce/campaign-management/campaigns/callout-extension-about.md)
               ...
               + [Associer [!DNL Google Ads] Extensions de légende partagées avec des campagnes ou des groupes publicitaires](/help/search-social-commerce/campaign-management/campaigns/callout-extension-associate.md)
            + [Gérer [!DNL Google Ads] extensions d’emplacement](/help/search-social-commerce/campaign-management/campaigns/location-extension-manage.md)
            + Extensions de lien de site {#sitelinks}
               ...
               + [Association de liens de site partagés à des comptes, des campagnes et des groupes publicitaires](/help/search-social-commerce/campaign-management/campaigns/sitelink-extension-associate.md)
      ...
      + Gestion des données en bloc via des feuilles d’envoi groupées {#bulksheets}
         ...
         + Données requises/incluses dans les feuilles d’envoi groupé{#bulksheet-data-formats}
            ...
            + [Données de feuille d’envoi groupé requises pour [!DNL Baidu] comptes](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-baidu.md)
            + [Données de feuille d’envoi groupé requises pour [!DNL Google Ads] comptes](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-google.md)
            + [Données de feuille d’envoi groupé requises pour [!DNL Microsoft Advertising] comptes](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-microsoft.md)
            + [Données de feuille d’envoi groupé requises pour [!DNL Naver] comptes](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-naver.md)
            + [Données de feuilles d’envoi groupé pour [!DNL Yahoo! Display Network] comptes](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-display-network.md)
            + [Données de feuilles d’envoi groupé pour [!DNL Yahoo! Japan] comptes](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-japan.md)
      ...
      + Automatisation des données de campagne à l’aide de flux de stock {#inventory-feeds}
         ...
         + Modèles {#feed-templates}
            ...
            + [[!DNL Google Ads] achats et paramètres du modèle de publicité](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-google-shopping.md)
            + [[!DNL Microsoft Advertising] achats et paramètres du modèle de publicité](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-microsoft-shopping.md)
         ...
         + Utilisation des données de campagne créées à partir de flux {#propagated-data}
            + [Affichage des données générées à partir de flux](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-view.md)
            + [Modification des données générées à partir de flux](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-edit.md)
            + [Données de campagne de publication générées à partir de flux vers les réseaux publicitaires](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-post.md)
            + [Arrêt d’une tâche de publication pour les données de flux d’inventaire](/help/search-social-commerce/campaign-management/inventory-feeds/stop-job.md)
            + [Statuts des données générées à partir de flux](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-status.md)
      + Mise en oeuvre de campagnes et de publicités avec des workflows uniques{#special-campaign-types}
         + [Mise en oeuvre [!DNL Google Ads] annonces de recherche dynamique](/help/search-social-commerce/campaign-management/special-campaign-types/google-dynamic-search-ads.md)
         + [Mise en oeuvre [!DNL Google Ads] campagnes de performances max](/help/search-social-commerce/campaign-management/special-campaign-types/google-performance-max-campaigns.md)
   ...
   + Gestion des classifications d’étiquettes {#label-classifications}
      + [À propos des classifications d’étiquettes](/help/search-social-commerce/campaign-management/label-classifications/classification-about.md)
      + [Création d’une classification d’étiquettes](/help/search-social-commerce/campaign-management/label-classifications/classification-create.md)
      + [Affectation de valeurs de classification à des composants de compte à partir des vues de gestion de campagne](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management.md)
      + [Affectation de valeurs de classification à des composants de compte à l’aide de feuilles d’envoi groupées](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets.md)
...
+ Statistiques et rapports {#insights-reports}
   + Informations publicitaires {#insights}
      + [A propos [!UICONTROL Advertising Insights]](/help/search-social-commerce/advertising-insights/insight-about.md)
      + [Générer une [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-generate.md)
      + [Affichage ou enregistrement d’une [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-view-save.md)
   ...
   + Rapports {#reports}
      ...
      + Gestion des rapports {#report-management}
         + Rapports de base et avancés {#basic-advanced-reports}
            ...
            + Formats de rapport avancés {#advanced-report-formats}
         ...
         + Rapports d’assistance {#assist-reports}
            + [À propos des rapports d’aide](/help/search-social-commerce/reports/management/assist/assist-report-about.md)
            + Aide aux formats de rapport {#assist-report-formats}
            ...
            + [Aide aux paramètres des rapports](/help/search-social-commerce/reports/management/assist/assist-report-settings.md)
         + Rapports de spécialité {#specialty-reports}
            + [À propos des rapports spécialisés](/help/search-social-commerce/reports/management/specialty/specialty-report-about.md)
            + Formats de rapport de spécialisation {#specialty-report-formats}
               ...
               + [La variable [!UICONTROL MSA Ad Extension by Ad Report]](/help/search-social-commerce/reports/management/specialty/msa-ad-extension-detail-report.md)
               + [La variable [!UICONTROL MSA Ad Extension by Keyword Report]](/help/search-social-commerce/reports/management/specialty/msa-ad-extension-by-keyword-report.md)
               + [La variable [!UICONTROL MSA Ad Extension Detail Report]](/help/search-social-commerce/reports/management/specialty/msa-ad-extension-by-ad-report.md)
               + [La variable [!UICONTROL MSA Network Impression Share Report]](/help/search-social-commerce/reports/management/specialty/msa-network-impression-share-report.md)
               + [La variable [!UICONTROL MSA Network Performance Report]](/help/search-social-commerce/reports/management/specialty/msa-network-performance-report.md)
         ...
         + Rapports sur la précision des modèles {#model-accuracy-reports}
            ...
            + Formats de rapport Précision des modèles {#assist-report-formats}
               + [La variable [!UICONTROL Forecast Accuracy Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-report.md)
               + [La variable [!UICONTROL Forecast Accuracy (Actuals) Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-actuals-report.md)
      ...
      + Automatisation des rapports {#report-automation}
         + Modèles de rapport {#report-templates}
            ...
            + [Modifier un modèle de rapport](/help/search-social-commerce/reports/automation/templates/template-edit.md)
         ...
         + Flux de feuille de calcul {#spreadsheet-feeds}
            ...
            + [Créez un [!DNL Excel] modèle pour un flux de rapport de feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
            ...
            + [Suppression de flux de rapports de feuille de calcul](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-delete.md)
   ...
   + Notifications {#notifications}
      ...
      + [Activation et désactivation des notifications push depuis [!UICONTROL Notification Center]](/help/search-social-commerce/notifications/notifications-push-enable-disable.md)
      + [Installez et désinstallez le [!UICONTROL Notification Center] application web](/help/search-social-commerce/notifications/notification-app-install-uninstall.md)
   + Alertes personnalisées {#alerts}
      ...
      + Modèles d&#39;alerte {#alert-templates}
         ...
         + [Modifier un modèle d’alerte personnalisé](/help/search-social-commerce/alerts/alert-template-edit.md)
...
+ Administration {#admin}
   ...
   + [Synchronisation [!DNL Adobe] audiences](/help/search-social-commerce/admin/sync-adobe-audiences.md)
   + Configuration des sources de données {#data-sources}
      + [A propos de la synchronisation [!DNL Google Analytics] mesures de conversion](/help/search-social-commerce/admin/data-sources/data-source-about.md)
      + [Conditions préalables à la configuration d’un [!DNL Google Analytics] source de données](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
      + [Configurez une [!DNL Google Analytics] vue comme source de données](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
      + [Modifier une [!DNL Google Analytics] source de données](/help/search-social-commerce/admin/data-sources/data-source-edit.md)
   ...
   + Gestion des mesures de conversion d’un annonceur{#conversion-metrics}
      ...
      + Gestion des balises de conversion {#conversion-tags}
