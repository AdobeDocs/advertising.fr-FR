...
Dans la liste des mesures que vous rendez disponibles, chaque utilisateur ayant accès aux données de l’annonceur peut personnaliser les mesures qu’il voit pour les vues et les rapports de gestion en incluant ou en omettant des mesures spécifiques. Les utilisateurs disposant de droits d’accès suffisants peuvent également optimiser des mesures spécifiques en les associant à des objectifs personnalisés au niveau des portfolios ou des packages DSP.
