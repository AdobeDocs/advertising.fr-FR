---
title: Mettez à jour le code de suivi AMO ID (s\_kwcid) pour une [!DNL Google Ads] account
...
# Mettre à jour le code de suivi s_kwcid pour un [!DNL Google Ads] account
