...
## (Nouvelle interface utilisateur) Supprimer les valeurs de classification de libellé
...
## (interface utilisateur héritée) Supprimer les valeurs de classification de libellé
