...
description: Découvrez comment créer un modèle d’annonce pour les flux de données d’inventaire.
...
Vous pouvez créer des modèles d’annonces spécifiques au moteur de recherche par le biais desquels vos données d’inventaire peuvent être traitées. Créez des modèles distincts pour les annonces textuelles étendues/étendues, les annonces de recherche réactive, [!DNL Google Ads] publicités commerciales et [!DNL Microsoft Advertising] publicités commerciales.

Outre la création de modèles entièrement nouveaux, vous pouvez éventuellement créer de nouveaux modèles en clonant des modèles existants.

Une fois que vous avez créé ou cloné un modèle et que vous l’avez associé à un fichier de flux de données, vous pouvez propager les données du fichier à travers le modèle afin de créer des données de campagne et une structure de compte.
...
1. Spécifiez les paramètres de la variable [modèle de publicité texte](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-text-rsa.md), [[!DNL Google Ads] modèle d&#39;annonce de shopping](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-google-shopping.md)ou [[!DNL Microsoft Advertising] modèle d&#39;annonce de shopping](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-microsoft-shopping.md):
   ...
   1. (Publicités textuelles uniquement) Cliquez sur le bouton **[!UICONTROL Keywords]** et indiquez les paramètres du mot-clé.
...
1. Enregistrez le modèle :
   ...
   * Pour enregistrer le modèle et propager le fichier de données spécifié par ce dernier, cliquez sur **[!UICONTROL Save]**, puis cliquez sur **[!UICONTROL Save & Propagate]**.
