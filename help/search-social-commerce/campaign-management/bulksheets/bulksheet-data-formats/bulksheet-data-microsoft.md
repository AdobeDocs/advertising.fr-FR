...
| [!UICONTROL Display Path 1] | (Annonces textuelles développées, annonces de recherches dynamiques et annonces de recherches réactives uniquement) Un chemin d’affichage supplémentaire ; voir l’entrée pour [!UICONTROL Display Path 1].<br><br>Exemple : si [!UICONTROL Display Path 1] est « affaires » et [!UICONTROL Display Path 2] est « local », l’URL d’affichage est &lt;<i>URL d’affichage</i>>/affaires/local, par exemple www.example.com/deals/local. |
