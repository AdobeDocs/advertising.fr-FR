...
>[!IMPORTANT]
>
>Les conversions suivies par [!DNL Google Ads] et la balise de suivi d’événement universel (UET) [!DNL Microsoft Advertising] ne sont pas rechargées sur les réseaux publicitaires. Si vous les incluez dans un objectif, vous devez les ajouter aux objectifs de la campagne dans l’éditeur du réseau publicitaire.
...
GGL_Lead n’est pas inclus dans le calcul/chargement car il s’agit d’une mesure suivie par [!DNL Google Ads]. La valeur objective pondérée est donc calculée comme suit : ((10 x 25) + (500 x 1) + (50 x 0,5)) = 775.
