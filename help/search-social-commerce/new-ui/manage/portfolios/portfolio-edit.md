...
>* Pour renommer rapidement un portfolio sans ouvrir les paramètres complets du portfolio, reportez-vous à la rubrique [Renommer un portfolio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-rename.md).

1. Dans le menu principal, cliquez sur **[!UICONTROL Manage]>[!UICONTROL Portfolios]**.

1. Effectuez l’une des opérations suivantes :

   * Placez le curseur sur la ligne du portfolio et cliquez sur ![Modifier Portfolio](/help/search-social-commerce/assets/settings-new.png "Modifier Portfolio").

   * Cochez la case en regard du portefeuille. Dans la barre d’outils des actions en bloc, cliquez sur ![Modifier](/help/search-social-commerce/assets/edit.png "Modifier").
