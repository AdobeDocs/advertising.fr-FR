...
## onglet [!UICONTROL Networks]

**[!UICONTROL Networks]:** (Rechercher des annonces) Comment et où placer des annonces dans le groupe d’annonces :

* *[!UICONTROL Only Bing and Yahoo websites]* (valeur par défaut) : pour placer des offres pour des annonces sur le réseau de recherche.

* *[!UICONTROL Only Bing and Yahoo syndicated search partners]:* pour placer des offres pour des annonces sur des sites partenaires syndiqués.
...
**[!UICONTROL Gender]:** (facultatif) Genres spécifiques à inclure ou à exclure en tant que cibles : *[!UICONTROL Male]*, *[!UICONTROL Female]* et *[!UICONTROL Unknown]*. Par défaut, tous les genres sont ciblés. Les exclusions remplacent toujours les inclusions.
...
**[!UICONTROL Age]:** (facultatif) Catégories d’âge spécifiques à inclure ou à exclure en tant que cibles : *[!UICONTROL 18-24]*, *[!UICONTROL 25-34]*, *[!UICONTROL 35-49]*, *[!UICONTROL 50-64]*, *[!UICONTROL 65+]* et *[!UICONTROL Unknown]*. Par défaut, tous les âges sont ciblés. Les exclusions remplacent toujours les inclusions.
...
**[!UICONTROL Company targets]:** (facultatif) Sociétés spécifiques issues des profils d’[!DNL LinkedIn] utilisateur à inclure ou exclure en tant que cibles. Par défaut, toutes les entreprises sont ciblées. Pour affiner le ciblage, recherchez et sélectionnez des entreprises individuelles et des organisations de niveau intermédiaire. Les exclusions remplacent toujours les inclusions.

* Pour cibler toutes les valeurs, ne sélectionnez aucune valeur.

* Pour inclure une valeur, cliquez une fois sur le cercle adjacent afin qu’une coche bleue (![Inclure](/help/search-social-commerce/assets/include.png "Inclure")) s’affiche. Vous avez la possibilité d&#39;augmenter ou de diminuer les enchères d&#39;un pourcentage spécifié pour chaque société ciblée.

* Pour exclure une valeur, cliquez deux fois sur le cercle adjacent afin d’afficher une coche rouge (![Exclure](/help/search-social-commerce/assets/exclude.png "Exclure")).

**[!UICONTROL Industry]:** (facultatif) Industries spécifiques des profils d’[!DNL LinkedIn] utilisateur à inclure ou à exclure en tant que cibles. Par défaut, tous les secteurs sont ciblés. Les exclusions remplacent toujours les inclusions.
...
**[!UICONTROL Job Function Targets]:** (facultatif) Fonctions de tâche spécifiques des profils d’[!DNL LinkedIn] utilisateur à inclure ou exclure en tant que cibles. Par défaut, toutes les fonctions sont ciblées. Les exclusions remplacent toujours les inclusions.
...
(Facultatif) Nombre de fois qu’un client peut recevoir des annonces du groupe d’annonces. Saisissez une valeur et sélectionnez l’unité de temps (*[!UICONTROL Hour]*, *[!UICONTROL Day]*, *[!UICONTROL Week]*) ou *[!UICONTROL Month]*).
