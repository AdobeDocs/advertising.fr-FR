---
title: (Nouvelle interface utilisateur) Modifier le statut d’un groupe publicitaire
...
# (Nouvelle interface utilisateur) Modifier le statut d’un groupe publicitaire
