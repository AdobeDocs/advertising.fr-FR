---
title: (Nouvelle interface utilisateur) Modifier le statut d’une campagne
description: Découvrez comment modifier le statut d’une campagne sans ouvrir les paramètres de la campagne.
...
# (Nouvelle interface utilisateur) Modifier le statut d’une campagne
