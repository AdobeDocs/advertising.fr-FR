---
title: (Nouvelle interface utilisateur) Afficher un graphique de performances dans la vue [!UICONTROL Campaigns]
description: Découvrez comment ouvrir et configurer un graphique de performances dans la vue [!UICONTROL Campaigns].
...
# (Nouvelle interface utilisateur) Afficher un graphique de performances dans la vue [!UICONTROL Campaigns]

*Fonction Beta*

Vous pouvez ouvrir et configurer un graphique de performances avec jusqu’à trois mesures totalisées sur toutes les campagnes de la vue pour la période spécifiée.
