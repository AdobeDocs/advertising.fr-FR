---
title: (Nouvelle interface utilisateur) À propos de la vue [!UICONTROL Ads]
description: Découvrez ce que vous pouvez faire dans la vue [!UICONTROL Ads].
...
# (Nouvelle interface utilisateur) À propos de la vue [!UICONTROL Ads]
...
* [Gérer les rapports de vue de données à partir de la vue [!UICONTROL Ads]](ad-view-report.md)

* [Modifier le statut d’une publicité](ad-change-status.md)
<!--
