...
## Appliquer les recommandations de dépenses {#spend-recommendations-apply}
...
## Ouvrir ou enregistrer des données en tant que fichier de classeur [!DNL Microsoft Excel] {#spend-recommendations-download}
