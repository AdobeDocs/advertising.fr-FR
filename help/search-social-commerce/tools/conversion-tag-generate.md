...
## (Nouvelle interface utilisateur) Générer et implémenter une balise de suivi des conversions dans Search, Social et Commerce
...
**[!UICONTROL Security]:** protocole de sécurité pour votre site web create: *[!UICONTROL Standard]* (pour les sites web qui utilisent HTTP) ou *[!UICONTROL Secure]* (pour les sites web qui utilisent HTTP).

**[!UICONTROL Properties]:** une ou plusieurs mesures de conversion à suivre lorsqu’un utilisateur final consulte une page contenant la balise de conversion. Pour ajouter une mesure à la liste, saisissez son nom dans le champ « [!UICONTROL Property name] » et cliquez sur **[!UICONTROL Add]**.
...
## (interface utilisateur héritée) Générer et implémenter une balise de suivi des conversions dans Search, Social et Commerce
...
1. Spécifiez les [paramètres de balise de conversion](#conversion-tag-settings-legacy).
...
### Paramètres des balises de conversion Adobe Advertising {#conversion-tag-settings-legacy}
...
## Implémenter les balises de suivi des conversions à l’aide des balises Adobe Experience Platform et de l’extension Adobe Advertising
