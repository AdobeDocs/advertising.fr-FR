...
| ---- | ------- | ----------- | -------------------- |
| 30 juin 2023 | [!UICONTROL Asset Library] | (Fonction bêta) Dans [!UICONTROL Campaigns] > [!UICONTROL Asset Library (Beta)], vous pouvez créer des ressources d’image, vidéo et texte réutilisables et les charger dans votre [!DNL Google] bibliothèque de ressources au niveau du compte. Vous pouvez utiliser vos ressources pour les publicités lorsque vous créez ou modifiez des campagnes dans la variable [!DNL Google Ads] éditeur. | Voir &quot;[Création et chargement de ressources](/help/search-social-commerce/campaign-management/asset-library/asset-create.md).&quot; |
