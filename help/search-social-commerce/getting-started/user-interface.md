...
* ![Notifications](/help/search-social-commerce/assets/notifications-aec.png "Notifications") Panneau répertoriant les demandes, notifications et annonces de CX Enterprise.
...
* ![Notifications d’alerte](/help/search-social-commerce/assets/notifications-panel.png "Notifications d’alerte") Panneau répertoriant vos notifications Search, Social et Commerce.
  ...
  Lorsque vous êtes connecté [via Adobe CX Enterprise](sign-in.md), ce panneau affiche vos notifications de CX Enterprise.
