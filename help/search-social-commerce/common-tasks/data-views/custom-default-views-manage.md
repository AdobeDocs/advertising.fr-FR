...
|   | Partager | (Vues personnalisées uniquement ; facultatif) Rend la vue disponible pour tous les autres utilisateurs qui peuvent afficher les données de l’annonceur. Les autres utilisateurs ne peuvent pas modifier ni supprimer la vue, mais ils peuvent en créer une à partir des paramètres. Dans vos listes de vues, chaque vue partagée par une autre personne est mise en italique, par exemple « _Campagnes les plus performantes_ ». |
