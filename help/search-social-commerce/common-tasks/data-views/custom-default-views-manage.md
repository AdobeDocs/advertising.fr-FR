...
Chaque vue est disponible sous la forme d’un raccourci dans la [!UICONTROL Custom Views] dans le panneau de gauche.
...
|  | Partager | (vues personnalisées uniquement) ; (facultatif) Rend la vue disponible pour tous les autres utilisateurs qui peuvent afficher les données de l’annonceur. Les autres utilisateurs ne peuvent ni modifier ni supprimer la vue, mais ils peuvent créer une vue à partir des paramètres. Dans vos listes de vues, chaque vue partagée par une autre personne est mise en italique, par exemple &quot;&quot;._Campagnes les plus performantes_.&quot; |
