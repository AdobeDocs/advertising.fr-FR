---
title: Copiez la clé de segment pour une audience réutilisable dans le presse-papiers.
...
# Copiez la clé de segment pour une audience réutilisable dans le presse-papiers.

Vous pouvez copier dans le presse-papiers la clé de segment alphanumérique (ID) d’une audience. Vous pouvez utiliser des clés de segment pour [définir manuellement la logique du segment](audience-segment-logic-syntax.md) pour d’autres audiences réutilisables.
...
1. Collez la clé de segment dans n’importe quel logiciel d’édition.
