---
title: Supprimer une audience réutilisable
...
# Supprimer une audience réutilisable

Vous pouvez supprimer une audience qui n’est utilisée dans aucun emplacement ni aucune autre audience réutilisable.

Si une audience est actuellement utilisée, vous avez la possibilité d’exporter une feuille de calcul [!DNL Microsoft Excel] présentant tous les emplacements et toutes les audiences qui utilisent l’audience.
...
1. (Si l’audience est utilisée à des emplacements ou dans d’autres audiences réutilisables ; facultatif) Cliquez sur **[!UICONTROL Export XLS]** pour télécharger un fichier de feuille de calcul (au format XLSX) conformément à la procédure normale de votre navigateur.
