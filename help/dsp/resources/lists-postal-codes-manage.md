---
title: Gérer les listes de codes postaux
description: Découvrez comment créer et gérer des listes de codes postaux pour le ciblage des emplacements.
...
## Afficher une liste de codes postaux

1. Dans le menu principal, cliquez sur **[!UICONTROL Resources]** > **[!UICONTROL Postal Code Lists]**.
...
## Créer une liste de codes postaux

1. Dans le menu principal, cliquez sur **[!UICONTROL Resources]** > **[!UICONTROL Postal Code Lists]**.

1. Dans le coin supérieur droit, cliquez sur **[!UICONTROL Create].**

1. Saisissez le **[!UICONTROL List name]**, sélectionnez le **[!UICONTROL Country]** applicable, puis cliquez sur **[!UICONTROL Create].**
