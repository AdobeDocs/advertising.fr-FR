...
* [**Optimisation**](features/optimization.md) : [!DNL Campaign Home] vous offre des outils avancés, un tri et des informations pour gérer et optimiser vos campagnes plus rapidement que jamais auparavant. En outre, les prévisions et les recommandations de dépenses prédisent les stratégies qui devraient donner de bons résultats, et pas nécessairement celles qui ont les meilleurs résultats en ce moment, afin que vous puissiez optimiser l’utilisation des données.
