...
Vous pouvez soit (a) configurer des ID d’opération privés directement avec [!DNL Roku] puis saisissez les données d’ID de transaction dans DSP ou b) consultez la variable [!DNL On Demand] Galerie à abonner [!DNL Roku] profils :
...
* **Prix négocié :** Utilisation de la fonction [!DNL Roku] l’équipe commerciale pour négocier et structurer un accord qui répond aux besoins de votre campagne.
...
Chaque [!DNL Roku] l’emplacement doit cibler au moins un [!DNL Roku] transaction ou source. Pour utiliser la correspondance de l’audience de DSP avec [!DNL Roku], incluez un ou plusieurs segments d’audience pouvant être mis en correspondance avec la variable [!DNL Roku] Jeu de données déterministes (opt-in).
...
* Cibler des offres existantes et toujours actives pour [!DNL Roku Network] in [[!DNL On Demand] Inventaire](/help/dsp/inventory/on-demand-inventory-subscribe.md) pour atteindre rapidement l’échelle [!DNL Roku] plateforme.
...
>[!MORELIKETHIS]
>
>* [Création manuelle des détails de l’identifiant de transaction](/help/dsp/inventory/deal-id-create.md)
