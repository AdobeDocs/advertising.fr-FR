---
title: Modifier les paramètres d’une transaction privée
...
# Modifier les paramètres d’une transaction privée

Les modifications apportées à une offre acceptée ne sont pas synchronisées à partir du fournisseur de services partagés. Si vous avez accepté une offre mais que l’éditeur a envoyé des modifications, vous pouvez modifier certains éléments des paramètres de l’offre depuis [!UICONTROL Inventory] > [!UICONTROL Deals]. Vous pouvez également renommer une offre à tout moment.

1. Dans le menu principal, cliquez sur **[!UICONTROL Inventory]** > **[!UICONTROL Deals].**

1. Dans la ligne d&#39;opération, cliquez sur **[!UICONTROL ...]** > **[!UICONTROL edit]**.

1. Modifiez les [paramètres des offres](deal-id-settings.md).
