...
Assurez-vous que votre compte dispose de suffisamment de crédit pour exécuter l’ensemble de la campagne. Vous pouvez vérifier et recharger les fonds du compte dans [!UICONTROL Settings] > [!UICONTROL Account] ou en contactant votre équipe de compte d’Adobe.
