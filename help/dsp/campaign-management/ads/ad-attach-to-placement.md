...
Utilisez la variable [!UICONTROL Ad Tools] pour joindre des publicités à des emplacements, joindre des pixels de suivi tiers aux publicités et détacher des pixels de suivi tiers existants des publicités.

>[!NOTE]
>
>Les publicités vidéo universelles ne peuvent être associées qu’à des emplacements vidéo universels.

## Ouvrez le [!UICONTROL Ad Tools] Affichage {#ad-tools-open}
...
1. Ouvrez le [!UICONTROL Ad Tools] d’une des manières suivantes :
   ...
   * (Dans la [!UICONTROL Ads] (vue) En regard du nom de la publicité, cliquez sur  **[!UICONTROL ...]** > **[!UICONTROL Add to Placements]**.
   ...
   La variable [!UICONTROL Attach Ads] est sélectionné par défaut.

## Joindre des publicités à des emplacements {#attach-ads-campaign}

1. [Ouvrez le [!UICONTROL Ad Tools] view](#ad-tools-open).
...
1. (Facultatif) Pour joindre d’autres publicités aux emplacements de la campagne, passez à la variable **[!UICONTROL Edit]** dans le coin supérieur droit. Voir l’étape 2 de la procédure précédente, &quot;[Joindre des publicités à des emplacements](#attach-ads-campaign),&quot; pour obtenir des instructions.

## Joindre des pixels de suivi tiers à des publicités dans un emplacement {#attach-pixels-ads}

1. [Ouvrez le [!UICONTROL Ad Tools] view](#ad-tools-open).

1. Cliquez sur le bouton **[!UICONTROL Attach Pixels]** .

1. Dans le [!UICONTROL Edit] subview :
   ...
   1. (S’il n’existe aucun pixel de suivi tiers pour la campagne) Créez un pixel :
      ...
      1. Spécifiez les paramètres :
         ...
         **[!UICONTROL Integration Event]:** L’événement qui déclenche le déclenchement du pixel, tel que *[!UICONTROL Impression]* ou *[!UICONTROL Click-through]*.
...
1. (Facultatif) Pour ajouter d’autres pixels aux publicités, passez à la **[!UICONTROL Edit]** dans le coin supérieur droit. Voir l’étape 3 de la procédure précédente, &quot;[Joindre des pixels de suivi tiers à des publicités dans un emplacement](#attach-pixels-ads),&quot; pour obtenir des instructions.
