...
Vous pouvez désarchiver une publicité pour restaurer son statut précédent à tout moment.
...
1. En regard du nom de l’annonce publicitaire, cliquez sur **[!UICONTROL ...]** > **[!UICONTROL Archive]**.
1. Dans le message de confirmation, cliquez sur **[!UICONTROL Archive]**.

>[!NOTE]
>
>Pour afficher les publicités archivées, filtrez l’affichage [!UICONTROL Ads] : cliquez sur ![[!UICONTROL Filter] bouton](/help/dsp/assets/filter.png) sur **[!UICONTROL Ad status]**, sélectionnez **[!UICONTROL Archived]**, puis sur **[!UICONTROL Apply].**
...
1. Cliquez sur le nom de la campagne.
1. Dans le sous-menu, cliquez sur **[!UICONTROL Ads]**.
1. En regard du nom de l’annonce publicitaire, cliquez sur **[!UICONTROL ...]** > **[!UICONTROL Unarchive]**.
