...
**[!UICONTROL Package]:** (Facultatif) Un package auquel l’emplacement est affecté. Cliquez sur ![Modifier](/help/dsp/assets/edit.png) pour sélectionner un package existant ou créer un package. Lorsque vous affectez l’emplacement à un module, la variable [!UICONTROL Goals] mise à jour de la section avec les dates de vol, l’objectif de diffusion et le budget du kit.
...
* *[!UICONTROL Set a Fixed Minimum or Maximum Budget]:* Permet de définir un budget d&#39;emplacement minimal et/ou maximal. Spécifiez au moins un type de budget :
   ...
   * *[!UICONTROL Minimum Budget]*: budget minimum en pourcentage du budget package. Lorsqu’un plafond d’intervalle est spécifié, la valeur de budget minimale est toujours calculée en pourcentage du plafond d’intervalle. Sinon, il est calculé sous la forme d&#39;un pourcentage du budget de package.
...
1. Effectuez l’une des opérations suivantes :
   * Pour ajouter un filtre :
      ...
      1. Suivant **[!UICONTROL Only bid if]**, sélectionnez une mesure, puis saisissez une valeur.
...
**[!UICONTROL Target Goal]:** L’objectif cible, qui est utilisé pour effectuer le suivi des performances.
...
* *[!UICONTROL ASAP]:* (La valeur par défaut) Accélère la diffusion à deux fois la vitesse de *Même*.
...
**[!UICONTROL Audience Location]:** (Facultatif) Emplacements spécifiques dans lesquels inclure ou exclure des publicités. Si vous ne spécifiez aucun emplacement, tous les emplacements sont ciblés.
...
1. Effectuez l’une des opérations suivantes :
   * Pour inclure ou exclure un pays, un État, une ville, une zone desservie, un district législatif fédéral ou un district législatif d’État :
      ...
      1. En regard de l’emplacement, cliquez sur *[!UICONTROL Include]* pour l’inclure en tant que cible ou *[!UICONTROL Exclude]* pour l’exclure comme cible.
   * Pour rechercher un code postal et inclure ou exclure tous les résultats sélectionnés :
      ...
      1. Cliquez sur *[!UICONTROL Include All]* pour inclure tous les emplacements comme cibles ou *[!UICONTROL Exclude All]* pour exclure tous les emplacements en tant que cibles.
...
* [!UICONTROL Private] | [!UICONTROL Roku Private]: vos offres privées existantes (ou celles existantes [!DNL Roku] offres [!DNL Roku] emplacements) avec les éditeurs que vous avez configurés dans DSP. Vous pouvez inclure, mais pas exclure, l’inventaire public.
   ...
   * *[!UICONTROL Ensure Fixed or Floor Price for the bid]*: (facultatif) remplace l’algorithme du prix de l’offre pour proposer au moins les prix fixes et plancher des offres.
...
* Pour cibler un type de stock :
   ...
   1. (Facultatif) Modifiez les sources pour inclure :
      ...
      1. Indiquez les sources à inclure et à exclure :
         * Pour inclure un [!UICONTROL Public] ou [!UICONTROL On Demand] source, cliquez sur **[!UICONTROL Include]** en regard du nom source.
         ...
         * Pour exclure une [!UICONTROL Public] ou [!UICONTROL On source], cliquez sur **[!UICONTROL Exclude]** en regard du nom source.
...
* *[!UICONTROL Tier 3]:* Cibles les niveaux 1 à 2 plus les sites et applications légitimes et sécurisés pour la marque qui répondent à un public de niche. Utilisez le niveau 3 pour la portée ou les achats de ciblage de données.
...
**[!UICONTROL Included Audiences]:** Toute cible d’audience pour l’emplacement, y compris [segments tiers, segments propriétaires, segments d’Adobe, segments personnalisés et audiences enregistrées](/help/dsp/audiences/audience-settings.md). La taille totale et active de l’audience dédupliquée pour tous les segments sélectionnés et les audiences enregistrées s’affiche également. Vous pouvez sélectionner une audience existante, créer une audience que vous pourrez réutiliser ultérieurement ou sélectionner des segments d’audience spécifiques :
...
**[!UICONTROL Excluded Audiences]:** Toutes les audiences à exclure pour l’emplacement, y compris les audiences avec [segments tiers, segments propriétaires, segments d’Adobe, segments personnalisés et audiences enregistrées](/help/dsp/audiences/audience-settings.md). La taille totale et active de l’audience dédupliquée pour toutes les audiences exclues s’affiche également. Vous pouvez sélectionner une audience existante ou créer une nouvelle audience que vous pourrez réutiliser ultérieurement :
...
1. (Facultatif) Pour télécharger un fichier CSV contenant les informations de ciblage sur l’emplacement de téléchargement de votre navigateur, cliquez sur **[!UICONTROL Export]**.
1. Cliquez sur **[!UICONTROL Save]**.
...
Quel niveau de [Ads.txt](https://iabtechlab.com/ads-txt-about/) filtrage pré-enchères à utiliser en appliquant la liste des vendeurs numériques autorisés de chaque éditeur. La valeur par défaut au niveau de l’annonceur est sélectionnée pour les nouveaux emplacements, mais vous pouvez modifier les paramètres :
