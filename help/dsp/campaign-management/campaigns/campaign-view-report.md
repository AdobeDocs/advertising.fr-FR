...
description: Découvrez comment ouvrir un rapport au niveau de la campagne avec des sections sur la géographie, les appareils, la visibilité et les données de performances des audiences.
...
Le rapport <!--legacy --> au niveau de la campagne comprend une vue d’ensemble et des sections sur les données [!UICONTROL Geography], [!UICONTROL Device], [!UICONTROL Viewability] et [!UICONTROL Audience Performance].
