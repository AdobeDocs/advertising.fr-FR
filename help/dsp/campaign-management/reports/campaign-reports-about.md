...
Vous pouvez en savoir plus [personnaliser les tableaux de données ;](campaign-data-views-about.md) par d’autres moyens et [filtrer les données visibles](campaign-data-filter.md).
