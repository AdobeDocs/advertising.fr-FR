...
#### Quelles méthodes d’attribution sont prises en charge dans le rapport [!UICONTROL Household Conversions] ?
...
| Méthodologie d’attribution | L’événement Dernière touche (impression ou clic) doit se trouver dans la fenêtre du classeur. | Uniques | Dernière touche |
| | Les points d’interaction plus de 30 jours avant l’événement Dernière touche sont pris en compte pour le chemin de conversion. | (CTV reçoit du crédit, quel que soit l’endroit où l’exposition CTV se produit dans le chemin de clic de l’utilisateur) | (CTV obtient du crédit si l’impression est le dernier événement de la période de recherche arrière ET qu’il n’y a aucun clic payant d’autres formats avant ou après l’exposition CTV) |
| Niveau de création de rapports | Granulaire | Granulaire | Large |
| | (Type de canal, Créatif/Publicité, Mot-clé, Chemins, Longueur, Durée De Conversion) | (Tactique CTV, application CTV/éditeur) | (Adobe Advertising et autres canaux marketing) |
| Canaux marketing | DSP + Recherche (dans Search, Social et Commerce) | DSP + Recherche (dans Search, Social et Commerce) | Canaux marketing non suivis par l’identifiant EF de clic publicitaire de l’Adobe Advertising (comme Recherche organique, Social organique, Courrier électronique et Affilié) |
...
Pour plus d’informations sur l’effet halo des services de mesure avancés sur les rapports de recherche, voir &quot;[Services de mesure avancés](/help/dsp/introduction/advanced-measurement-services.md)&quot;.
