...
Vous pouvez télécharger n’importe quelle instance de rapport terminée des quatre derniers mois, dont le statut est [status](report-about.md#custom-report-status) « [!UICONTROL Ready to Download] » ou « [!UICONTROL Completed] ».
