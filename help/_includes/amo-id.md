...
Consultez la [Formats des éléments de dimension ID AMO](https://experienceleague.adobe.com/en/docs/analytics/components/dimensions/amo-id#dimension-items) dans le « Guide des composants d’Adobe Analytics ».
