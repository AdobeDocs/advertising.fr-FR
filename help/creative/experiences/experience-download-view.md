...
description: Découvrez comment exporter des métadonnées à partir de la vue [!UICONTROL Experiences].
...
Chaque ligne du fichier contient des détails sur une expérience, notamment : le nom et l’identifiant de l’expérience ; si l’expérience inclut des annonces dynamiques ou non ; le nombre de contenus publicitaires, de lots et de balises d’annonce associées ; si l’expérience inclut une arborescence de décision ; les tailles de contenu créatif incluses ; les libellés applicables ; l’image miniature que [!DNL Creative] affiche pour l’expérience ; le nom des lots attribués ; et les noms des balises d’annonce associées.
