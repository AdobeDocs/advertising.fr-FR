...
+ Bibliothèques Creative {#creative-libraries}
   ...
   + Créatifs {#creatives}
      ...
      + [Affichage du journal des modifications d’un élément créatif](/help/creative/creative-libraries/creative-view-change-log.md)
...
+ [Annexe : champs disponibles pour les fichiers dynamiques et de flux](/help/creative/appendix-available-feed-fields.md)
+ Rapports de performance {#reports}
   ...
   + [Affichage des alertes](/help/creative/reports/alerts-view.md)
   + [ Rapports personnalisés ]{#custom-reports}
      + [À propos des rapports personnalisés](/help/creative/reports/reports-about.md)
      + [Gestion des rapports personnalisés](/help/creative/reports/report-manage.md)
...
+ [Notes de mise à jour de Adobe CX Enterprise](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html){target="_blank"}
