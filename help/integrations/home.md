...
| ---- | ------- | ----------- | -------------------- |
| 19 juillet 2023 | Reporting | (DSP utilisateurs avec [!DNL Analytics for Advertising]) Les conversions d’affichages publicitaires pour les emplacements de télévision connectée (CTV) sont désormais disponibles dans une nouvelle [!UICONTROL Household Conversions Report]. Auparavant, ils étaient inclus uniquement dans Adobe Analytics. | Voir &quot;[Questions fréquentes sur les rapports sur les ménages](/help/dsp/reports/faq-household-report.md).&quot; |
