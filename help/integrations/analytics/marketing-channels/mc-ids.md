---
title: Utilisation des identifiants d’Adobe Advertising à créer [!DNL Marketing Channels] Règles
description: Découvrez comment utiliser des ID d’Adobe Advertising pour créer des règles de traitement pour [!DNL Analytics Marketing Channels].
...
# Utilisation des identifiants d’Adobe Advertising à créer [!DNL Marketing Channels] Règles de traitement

*Annonceurs avec une intégration Adobe Advertising-Adobe Analytics uniquement*

Vous pouvez utiliser des identifiants d’Adobe Advertising ([AMO ID et EF ID](../ids.md)) pour configurer [!DNL Marketing Channels] règles de traitement dans Adobe Analytics. Utilisez des identifiants d’Adobe Advertising pour les règles spécifiques à vos campagnes d’Adobe Advertising.
