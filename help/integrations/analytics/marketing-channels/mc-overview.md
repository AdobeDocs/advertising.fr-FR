...
En utilisant des règles de traitement [!UICONTROL Marketing Channels], vous pouvez créer des ensembles de logiques pour déterminer les canaux qui génèrent du trafic et pour suivre chaque canal au fur et à mesure que les utilisateurs et utilisatrices accèdent à votre site. Par exemple, le canal [!UICONTROL Email] est indiqué par un code de suivi unique généré lors des clics qui, lorsqu’il est connecté par Adobe Analytics, classe la visite comme provenant d’une campagne marketing par e-mail.
