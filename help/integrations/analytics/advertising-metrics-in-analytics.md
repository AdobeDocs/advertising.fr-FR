...
>[!NOTE]
>
>* Adobe Advertising transmet quotidiennement les mesures et dimensions de trafic à [!DNL Analytics].
>* [!DNL Analytics] capture les clics publicitaires et les affichages publicitaires Adobes Advertising en temps réel.
>* Pour [!DNL Search, Social, & Commerce], cette fonctionnalité est prise en charge pour la plupart des réseaux publicitaires et des types de campagne. Pour plus d’informations, voir &quot;[Inventaire pris en charge](/help/search-social-commerce/introduction/supported-inventory.md)&quot; dans le guide [!DNL Search, Social, & Commerce].

## Mesures de trafic d’un Adobe Advertising

Les mesures de trafic d’Adobe Advertising dans [!DNL Analytics] commencent généralement par &quot;Adobe Advertising&quot;, à l’exception de &quot;[!UICONTROL AMO ID Instances]&quot;. Toutefois, pour les clients à long terme qui ont utilisé un événement personnalisé (plutôt qu’un événement réservé) pour créer initialement des mesures pour les clics, les coûts et les impressions, ces mesures commencent toujours par &quot;AMO&quot;.
...
>[!NOTE]
>
>Toutes les dimensions d’Adobe Advertising de [!DNL Analytics] sont suivies de &quot;[!DNL (AMO ID)]&quot;.

| Dimension | Données d’Adobe Advertising applicables | Description |
| ----------- | ---------- | ---------- |
| [!UICONTROL Ad Platform (AMO ID)] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | Advertising DSP ou nom du moteur de recherche |
| [!UICONTROL Account (AMO ID] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | Nom du compte. |
| [!UICONTROL Network (AMO ID)] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | RTB ([!DNL DSP]) ou nom du réseau publicitaire ([!DNL Search, Social, & Commerce]) |
| [!UICONTROL Campaign (AMO ID)] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | Nom de la campagne. |
| [!UICONTROL Optimization (AMO ID)] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | Nom du package ([!DNL DSP]) ou du portfolio ([!DNL Search, Social, & Commerce]). |
...
| [!UICONTROL Ad Type (AMO ID)] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | Type de publicité, par exemple `text`, `video`, `display` ou `native`. |
| [!UICONTROL Ad Title (AMO ID)] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | Type de publicité ([!DNL DSP]) ou titre de publicité ([!DNL Search, Social, & Commerce]). |
| [!UICONTROL Ad Description (AMO ID)] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | Description de la publicité ([!DNL DSP]) ou corps de la publicité ([!DNL Search, Social, & Commerce]). |
...
| [!UICONTROL Landing Type (AMO ID)] | [!DNL DSP] et [!DNL Search, Social, & Commerce] données | Indique si l’entrée de la page d’entrée était un affichage ou un clic publicitaire. |
...
* Taux d’impression affichable ([!UICONTROL Adobe Advertising Viewable Impressions] / [!UICONTROL Adobe Advertising Measureable Impressions] * 100)
