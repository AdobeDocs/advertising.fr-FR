...
+ [!DNL Analytics for Advertising] {#analytics}
  ...
  + Planification de l’implémentation {#planning}
    + [Conditions préalables et informations clés pour la mise en œuvre  [!DNL Analytics for Advertising]](/help/integrations/analytics/prerequisites.md)
    + [(DSP) Code JavaScript pour  [!DNL Analytics for Advertising]](/help/integrations/analytics/javascript.md)
    + [Utilisation de la bibliothèque  [!DNL Last Event Service] JavaScript avec Adobe Experience Platform [!DNL Web SDK]](/help/integrations/analytics/web-sdk.md)
    ...
    + (DSP) Macros pour les balises de publicité {#macros}
      + [Ajout  [!DNL Analytics for Advertising]  macros aux balises  [!DNL Flashtalking] ’annonces](/help/integrations/analytics/macros-flashtalking.md)
  ...
  + Données échangées {#data}
    ...
    + [[!DNL Analytics] des données dans Adobe Advertising](/help/integrations/analytics/analytics-data-in-advertising.md)
...
+ Intégration à Adobe Audience Manager {#audience-manager}
  ...
  + Intégration des données DSP media à Adobe Audience Manager {#media-data-ingestion}
    ...
    + [Collecter des données d’impression et de clic à partir de campagnes DSP](/help/integrations/audience-manager/media-data-integration/collect.md)
...
+ Intégration avec Adobe Target {#target}
  + [Configuration des tests A/B dans Adobe Target pour les publicités DSP](/help/integrations/target/ab-tests-dsp.md)
  + [Configurer des tests A/B dans Adobe Target pour les publicités Search, Social et Commerce](/help/integrations/target/ab-tests-search.md)
+ Intégration avec Adobe Customer Journey Analytics {#customer-journey-analytics}
  ...
  + [Dépannage](/help/integrations/customer-journey-analytics/troubleshooting.md)
  + {hide-from-toc}[Dépannage](/help/integrations/customer-journey-analytics/troubleshooting-new.md)
  + {hide-from-toc}[Dépannage](/help/integrations/customer-journey-analytics/troubleshooting-new-accordian.md)
  + {hide-from-toc}[Dépannage](/help/integrations/customer-journey-analytics/troubleshooting-new-tables.md)
+ [Tutoriels vidéo sur les intégrations d’Adobe Advertising](https://experienceleague.adobe.com/docs/advertising-learn/tutorials/overview.html?lang=fr)
